...
const ja = {
  ...
  referralCodeFromLink: '紹介リンクから来られたので、コードを入力済みです。変更・削除もできます。',
...
const en: Record<keyof typeof ja, string> = {
  ...
  referralCodeFromLink: 'You arrived from a referral link, so the code is filled in. You can change or clear it.',
