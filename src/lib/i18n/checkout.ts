...
const ja = {
  ...
  guildTitle: '枡を持って、世界とつながる',
  guildBody: 'FOMUS GUILD は、枡を通じて世界とつながる人たちのコミュニティです。まっすーが枡を持ってセブ島・ヨーロッパ・中東を歩いた活動記録485本を、無料登録で全文読めます。',
  guildReferral: '会員になると紹介リンクがもらえて、そこから枡が売れると売上の10%がポイントで戻ってきます。',
  guildCta: 'FOMUS GUILD を見る（無料）',
...
const en: Record<keyof typeof ja, string> = {
  ...
  guildTitle: 'Connect with the world through MASU',
  guildBody: 'FOMUS GUILD is a community of people connected through MASU. Sign up free to read all 485 posts from MaSU\u2019s travels with a masu \u2014 Cebu, Europe, the Middle East and more.',
  guildReferral: 'Members get a referral link: when someone buys a MASU through it, 10% of the sale comes back to you as points.',
  guildCta: 'Visit FOMUS GUILD (free)',
