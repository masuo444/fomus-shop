...
export default function ShareButtons({ url, title }: ShareButtonsProps) {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        onClick={shareToLine}
        className="w-9 h-9 flex items-center justify-center rounded-full border border-gray-200 text-gray-500 hover:bg-[#06C755] hover:text-white hover:border-[#06C755] transition-colors"
        title="LINEでシェア"
      >
        <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
