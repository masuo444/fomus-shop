          ...
          <nav className="hidden md:flex items-center gap-10">
            ...
            {siteConfig.features.brandPages && (
              <>
                ...
                <a href={locale === 'en' ? 'https://www.fomus.jp/kumiki/en/' : 'https://www.fomus.jp/kumiki/'} target="_blank" rel="noopener" className="text-xs tracking-[0.15em] uppercase text-[var(--color-muted)] hover:text-[var(--foreground)] transition-colors">
                  KUMIKI
                </a>
              </>
            )}
          ...
          <div className="md:hidden border-t border-[var(--color-border)] py-8 space-y-5">
            ...
            {siteConfig.features.brandPages && (
              <>
                ...
                <a href={locale === 'en' ? 'https://www.fomus.jp/kumiki/en/' : 'https://www.fomus.jp/kumiki/'} target="_blank" rel="noopener" className="block text-xs tracking-[0.15em] uppercase text-[var(--color-muted)] hover:text-[var(--foreground)]" onClick={() => setMenuOpen(false)}>
                  KUMIKI
                </a>
              </>
            )}
