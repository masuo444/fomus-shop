...
// GET: Get single order with items (verify shop_id matches)
...
// PUT: Update order status (e.g., mark as processing, add tracking)
export async function PUT(
  ...
  // Verify order belongs to partner's shop
