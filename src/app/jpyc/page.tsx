...
export const metadata: Metadata = {
  title: 'JPYC決済について',
  description: `${siteConfig.name}ショップではJPYC（日本円ステーブルコイン）で枡やグッズを購入できます。Polygonネットワーク対応。暗号資産で伝統工芸品を買える、ちょっと面白い体験。`,
  alternates: {
    canonical: '/jpyc',
  },
}
...
export default function JpycPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 sm:px-8 lg:px-10">
      ...
      <HowToJsonLd
        name={`JPYCで${siteConfig.name}の商品を購入する方法`}
        description={`日本円ステーブルコインJPYCを使って${siteConfig.name}オンラインショップで商品を購入する手順`}
        steps={[
      ...
      <FAQPageJsonLd items={[
        ...
        { question: `${siteConfig.name}でJPYCで何が買えますか？`, answer: `枡、カードゲーム、ランニングウェアなど、${siteConfig.name}の全商品をJPYCで購入できます。` },
      ...
      <section className="pt-20 pb-16 md:pt-32 md:pb-24">
        ...
        <p className="text-xs leading-[2.2] text-[var(--color-muted)] max-w-lg">
          日本円ステーブルコイン「JPYC」で、{siteConfig.name}の枡やグッズを購入できます。
      ...
      <section className="py-16 md:py-20">
        ...
        <div className="space-y-6">
          {[
            ...
            { q: `${siteConfig.name}でJPYCで何が買えますか？`, a: `枡、カードゲーム、ランニングウェアなど、${siteConfig.name}の全商品をJPYCで購入できます。` },
